...
def showPatches(patches):
    '''
    Accepts image patches and displays them if SHOW_PATCHES is True
    '''
    ...
    # Need to investigate what this code block is doing. 
...
def createPatches(input_paths, out_hr_path, out_lr_path,):
    '''
    Creates directories to save high and low resolution image patches in the input directory.
    Also create patches from input images. 
    '''
